...
BEGIN
  FOR i IN 1..100000 LOOP
      fn := FIRST_NAME_list(SYS.DBMS_RANDOM.VALUE(1, 20));
      ln := LAST_NAME_list(SYS.DBMS_RANDOM.VALUE(1, 15));
    ...
    VALUES (fn,
            ...
            to_date(FLOOR(SYS.DBMS_RANDOM.VALUE(1, 32)) || '-01-2024', 'dd-mm-yyyy'),
            SYS.DBMS_RANDOM.string('u',2),
            floor(SYS.DBMS_RANDOM.VALUE(1000, 40000)),
            null,
            floor(SYS.DBMS_RANDOM.VALUE(1, 100)));
  END LOOP;
  COMMIT;
